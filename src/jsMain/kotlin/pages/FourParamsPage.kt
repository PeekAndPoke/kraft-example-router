...
fun Tag.FourParamsPage(
    p1: String,
    p2: String,
    p3: String,
    p4: String,
) = comp(
    FourParamsPage.Props(p1 = p1, p2 = p2, p3 = p3, p4 = p4)
) {
    FourParamsPage(it)
}

class FourParamsPage(ctx: Ctx<Props>) : Component<FourParamsPage.Props>(ctx) {
